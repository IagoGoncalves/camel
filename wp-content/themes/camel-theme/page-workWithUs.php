...
get_header(); ?>
    <main id="workWithUS" class="workWithUS-page" tabindex="-1" role="main">
        <?php set_query_var('parameter', esc_html('Trabalhe conosco')); get_template_part('parts/breadcrump');?>
        <div class="container">
            <h2 class="h2-bold-title"><?php echo esc_html(get_field('titulo_da_secao')); ?></h2>
            <p class="h2-light"><?php echo esc_html(get_field('texto_da_secao')); ?></p>
        </div>
